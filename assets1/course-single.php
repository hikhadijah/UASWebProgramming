...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="http://sttbandung.ac.id">STT Bandung</a></div>
    ...
    <div class="intro-section single-cover" id="home-section">
      ...
      <div class="slide-1 " style="background-image: url('<?php echo base_url();?>assets/images/img_2.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            <h2 class="section-title">More Programs</h2>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.php"><img src="<?php echo base_url();?>assets/images/img_1.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
                <span class="course-price">#1</span>
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Industrial Engeneering</a></h3>
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.php"><img src="<?php echo base_url();?>assets/images/img_2.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
                <span class="course-price">#2</span>
                <div class="meta"><span class="icon-clock-o"></span>4 Lessons / 12 week</div>
                <h3><a href="#">Informatics Engeneering</a></h3>
                <p>Lorem ipsum dolor sit amet ipsa nulla adipisicing elit. </p>
              </div>
              <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-users"></span> 2,193 students</div>
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.php"><img src="<?php echo base_url();?>assets/images/img_3.jpg" alt="Image" class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
