    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="text-black mb-4"><a href="#">STT Bandung</a></div>

          <div class="mx-auto text-center">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                <li><a href="#home-section" class="text-black mb-4">Home</a></li>
                <li><a href="#courses-section" class="text-black mb-4k">Study Programs</a></li>
                <li><a href="#programs-section" class="text-black mb-4">Students</a></li>
                <li><a href="#teachers-section" class="text-black mb-4">Teachers</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="<?= site_url("login/logout"); ?>" class="nav-link"><span>Log Out</span></a></li>
              </ul>
            </nav>
